LEXICON: dict[str, str] = {
    ...
    "back": "Назад🔙",
    "check_metrics": "Посмотреть свои метрики👁",
    "add_metrics": "Добавить метрики➕",
    "send_metrics": "Пришлите Ваши метрики, полученные с устройства InBody🖥️\nВ формате: \"<рост> <вес> <процент жира>\""
}